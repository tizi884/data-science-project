...
\noindent The project aims to leverage machine learning to support preventive medicine by identifying individuals with risky lifestyle behaviors (smoking and alcohol consumption) using objective biomedical data.

The specific, measurable goals of the predictive modeling effort are to:

\noindent \textbf{Accurately Classify Individuals:} Develop models that can accurately classify an individual’s smoking and alcohol consumption patterns based purely on objective clinical measurements.

\noindent \textbf{Provide Interpretable Predictions:} Generate predictions and insights that are interpretable and actionable, allowing healthcare professionals to effectively use them in clinical practice.

\noindent \textbf{Identify Relevant Biomarkers:} Determine and rank the most relevant biomarkers that effectively signal lifestyle-related health risks.
